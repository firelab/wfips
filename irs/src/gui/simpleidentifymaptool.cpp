...
SimpleIdentifyMapTool::SimpleIdentifyMapTool(QgsMapCanvas *mapCanvas)
    : QgsMapToolIdentify(mapCanvas)
{
}

void SimpleIdentifyMapTool::canvasReleaseEvent(QMouseEvent *e)
{
