...
CrossThread::CrossThread(FlamMap *_pFlamMap) : poly(_pFlamMap)
{
     NumCross=0;
     NumAlloc=0;
     intersect=0;
...
void CrossThread::StartCrossThread(long threadorder, long currentfire, long nextfire)
{
	HANDLE hXThread;
     ...
     {	ThreadOrder=threadorder;
          ...
          hXEvent=pFlamMap->GetFarsiteEvent(EVENT_CROSS_THREAD, ThreadOrder);
	...
	double ros1, ros2, ros3, fli1, fli2, fli3, fli4;
     ...
     {    NumCross=0;
     	...
     	{	xpt=GetPerimeter1Value(CurrentFire, i, XCOORD);
          ...
          pFlamMap->SetFarsiteEvent(EVENT_CROSS, ThreadOrder);
